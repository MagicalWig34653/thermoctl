...
jedem Kästchen. Dort stand bis hierher die ASCII-Umschrift, die im Quelltext dieses
Projekts für Kommentare gilt -- "Sollwerte je Modus ändern". In der Oberfläche liest
...
# soll denselben Stand einspielen, egal wie die Liste im Modell später aussieht.
NEU: dict[str, str] = {
