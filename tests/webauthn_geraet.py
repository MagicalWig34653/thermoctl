...
class WebAuthnGeraet:
    ...
    def _authenticator_daten(self, rp_id: str, *, mit_credential: bool) -> bytes:
        ...
        daten += struct.pack(">I", self.zaehler)
        if mit_credential:
    ...
    def anmelden(
        self, argumente: dict[str, Any], origin: str, *, zaehler: int | None = None
    ) -> dict[str, Any]:
        ...
        self.zaehler = self.zaehler + 1 if zaehler is None else zaehler
...
__all__ = ["WebAuthnGeraet", "base64url_to_bytes", "bytes_to_base64url"]
